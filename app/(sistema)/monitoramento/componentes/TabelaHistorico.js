...
export default function TabelaHistorico({ estacao }) {
  ...
  const filtros = {
    ...
    "7d": { limit: 100, label: "Últimos 100 registros" },
    "30d": { limit: 300, label: "Últimos 300 registros" }
  }
    ...
    <div className="bg-white border border-slate-200 rounded-[2rem] shadow-2xl shadow-slate-300/20 p-6 md:p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-[11px] font-black text-slate-500 uppercase tracking-[0.2em]">{filtros[periodo].label}</p>
        </div>
      ...
      {/* Segurança de Escala: max-h-500px com scroll elegante */}
