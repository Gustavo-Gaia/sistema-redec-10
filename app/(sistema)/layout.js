...
// 🚀 IMPORTANTE: Importando o Provider para que o Dashboard tenha acesso aos dados
...
export default function SistemaLayout({ children }) {
  ...
  return (
    <div className="h-full flex overflow-hidden">
      {/* Envolvemos o sistema com o Provider. 
         Isso garante que o robô do Supabase comece a ouvir os dados 
         assim que o usuário logar no sistema.
      */}
      <MonitoramentoProvider>
        ...
        <div className="flex-1 flex flex-col h-full overflow-y-auto bg-transparent">
          ...
          {/* Conteúdo dinâmico (Dashboard, Monitoramento, etc) */}
